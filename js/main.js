...
function pam250() {
    ...
    var dataArray = _.map(lines, function (line) {
        return line.split(" ");
    });

    var pam250 = {};
    _.each(headers, function (header) {
        return pam250[header] = {};
    });
    _.each(headers, function (headerRow) {
        return _.each(headers, function (headerCol) {
